...
import static ir.mimdolt.store.config.SecurityConfig.REMEMBER_ME_KEY;
...
public class RememberMeServices extends
    ...
    protected RememberMeServices(String key, org.springframework.security.core.userdetails.UserDetailsService userDetailsService) {
